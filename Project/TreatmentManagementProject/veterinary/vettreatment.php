...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1"><br>ระบบตรวจรักษา</div></center>
   <center>
   <table border="0">
   <tr>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" 
   onclick="window.open('<?php echo  $vetchooseroom; ?>','_self');">เลือกห้องตรวจ</button></td>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" 
   onclick="window.open('<?php echo $vetshowtreatment; ?>','_self');">รายการตรวจรักษา</button></td>
