...
{
  echo "<script>window.open('vetchooseroom.php','_self');</script>";
}
?>
<!doctype html>
<html lang="en">
...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1"><br>ขณะนี้คุณประจำอยู่ที่ห้องตรวจ</div></center>
   <center>
   <form action="vetdelroomsave.php" method="post">
   
   <table border="0" width="40%">
   <tr>
   <td align="center">
   <div style="width: 100%;">
    <h2><?php echo $record['roomname']; ?></h2>
    <input type="hidden" name="treatmentroomid" value="<?php echo $record['treatmentroomid']; ?>">
    </div>
    </td>
    <tr><td align="center"><input class="btn btn-primary" type="submit" value="ย้ายห้องตรวจ"></td></tr>
