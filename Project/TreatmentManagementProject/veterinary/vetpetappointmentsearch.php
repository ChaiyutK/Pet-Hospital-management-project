...
<center><div class="head1">ข้อมูลสัตว์เลี้ยง</div></center>
   ...
   <td align="center" width="20%">
   <a href="vetpetappointmentsearch.php?petid=<?php echo $petid; ?>" class="btn btn-info" role="button" style="height:100%;width:100%;">นัดหมาย</a>
   </td>
   </tr>
   <tr><td colspan="5">
    ...
    <tr align="center">
        ...
        $x=mysqli_num_rows($result);
         ...
         for($i=1;$i<=$count2;$i++)
         {
            ...
            ?>
            <a href='vetpetappointmentsearch.php?count=<?php echo $count ?>&page=<?php echo $i ?>&petid=<?php echo $petid ?>'><?php echo $i; ?>&nbsp;</a>
            <?php
