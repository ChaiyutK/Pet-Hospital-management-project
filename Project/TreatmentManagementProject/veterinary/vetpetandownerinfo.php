...
.btmenu {
 margin: 5%;
       ...
       function OwnerInfo(rec,rec2)
            {
                window.open("vetpetandowner.php?&petid=" + rec,"_self");
            }
      </script>
  </head>
  <body>
...
<center><div class="head1">ข้อมูลสัตว์เลี้ยง</div></center>
   ...
   <td align="center" width="20%">
   <a href="vetpetandowner.php?petid=<?php echo $petid; ?>" class="btn btn-info" role="button" style="height:100%;width:100%;">ข้อมูลเจ้าของสัตว์เลี้ยง</a>
   </td>
   <td align="center" width="20%">
   ...
   <table width = '100%' border = "0"  bgcolor = "#FFFFFF">
            ...
            <select name="level" disabled>
               ...
               <td align = "left">รหัสไปรษณีย์ :</td><td><input type="text" name="Postnumber" size='30' maxlength='30' value="<?php echo $record['postnumber']; ?>" disabled></td>
                ...
                <tr><td colspan="4" align="center"><button class="btn btn-info" onclick="OwnerInfo('<?php echo $petid; ?>')">กลับ</button></td></tr>
    </table>
    </td></tr>
</table>
<br>
