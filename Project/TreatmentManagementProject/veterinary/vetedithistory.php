...
<center><div class="head1">ข้อมูลบุคคล</div></center>
   <center>
   <form action="vetedithistorysave.php" method="post">
    <table width = '50%' border = "0"  bgcolor = "#FFFFFF">
               <tr>
               <td align = "right">ชื่อ : </td><td><input type="text" name="Fname" size='30' maxlength='30' value="<?php echo $record['name']; ?>" ></td>
               <td align = "left">นามสกุล : </td><td><input type="text" name="Sname" size='30' maxlength='30' value="<?php echo $record['surname']; ?>" ></td>
               </tr>
               <tr>
               <td align = "right">บ้านเลขที่ : </td><td><input type="text" name="Hnumber" size='30' maxlength='30' value="<?php echo $record['hnumber']; ?>" ></td>
               <td align = "left">หมู่บ้าน/อาคาร : </td><td><input type="text" name="Village" size='30' maxlength='30' value="<?php echo $record['village']; ?>" ></td>
               </tr>
               <tr>
               <td align = "right">ตรอก/ซอย : </td><td><input type="text" name="Alley" size='30' maxlength='30' value="<?php echo $record['alley']; ?>" ></td>
               <td align = "left">ถนน : </td><td><input type="text" name="Road" size='30' maxlength='30' value="<?php echo $record['road']; ?>" ></td>
               </tr>
               <tr>
               <td align = "right">แขวง : </td><td><input type="text" name="District" size='30' maxlength='30' value="<?php echo $record['district']; ?>" ></td>
               <td align = "left">เขต/อำเภอ : </td><td><input type="text" name="Canton" size='30' maxlength='30' value="<?php echo $record['canton']; ?>" ></td>
               </tr>
               <tr>
               ...
               <td align = "left">รหัสไปรษณีย์ :</td><td><input type="text" name="Postnumber" size='30' value="<?php echo $record['postnumber']; ?>" maxlength='5' onkeypress="return isNumber(event)" required></td>
               </tr>
                <tr><td colspan="2" align="right">เบอร์โทรศัพท์บ้าน :&nbsp;</td><td colspan="2" align="left"><input type="text" name="Hpnumber" value="<?php echo $record['hpnumber']; ?>" maxlength='9' onkeypress="return isNumber(event)" required></td></tr>
                <tr><td colspan="2" align="right">เบอร์โทรศัพท์มือถือ :&nbsp;</td><td colspan="2" align="left"><input type="text" name="Phonenumber" value="<?php echo $record['phonenumber']; ?>" maxlength='10' onkeypress="return isNumber(event)" required></td></tr>
