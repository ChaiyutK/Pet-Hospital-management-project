...
<center><div class="head1"><br>กรุณาเลือกระบบที่ต้องการ</div></center>
   ...
   <table border="0">
   <tr>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $vetedithistory; ?>','_self');">แก้ไขประวัติ</button></td>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $veteditpassword; ?>','_self');">แก้ไขรหัสผ่าน</button></td>
   </tr>
   </table>
   </center>
