...
<br><br>
<h1 align="center" class="head1 ">เพิ่มโรค</h1>
<center>
    <br>
    <div style="width: 80%;">
    <form action="ManagediseaseAddSave.php" method="post">
    <table width = '50%' border = "1"  bgcolor = "#FFFFFF">
            <tr><td colspan="2" align="right">
            รหัสโรค :&nbsp;
            <td colspan="2" align="left">
            <input type="text" size='30' name="diseaseid" maxlength='6' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ชื่อโรค :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="dname" size='30' maxlength='100' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ประเภทการรักษา :&nbsp;
            <td colspan="2" align="left">
            ...
            กลุ่มอาการ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="syndrome" size='30' maxlength='100' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ประเภทโรค :&nbsp;
            <td colspan="2" align="left">
            <select name="typedisease">
               ...
               <option value='1'>โรคระบาดสัตว์</option>
               <option value='2'>โรคติดต่อระหว่างสัตว์และคน</option>
               </select>
                </td></tr>
