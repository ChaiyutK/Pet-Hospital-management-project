...
$sql ="SELECT `treatmentroomid`, `name`, `VetID` FROM `treatmentroom` where treatmentroomid='$treatmentroomid'";
...
<br><br>
<h1 align="center" class="head1 ">แก้ไขห้องตรวจ</h1>
<center>
    <br>
    <div style="width: 80%;">
    <form action="ManagetreatmentroomEditSave.php" method="post">
    <table width = '50%' border = "1"  bgcolor = "#FFFFFF">
            <tr><td colspan="2" align="right">
            รหัสห้องตรวจ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" size='30' maxlength='2' value="<?php echo $record['treatmentroomid']; ?>" disabled>
            <input type="hidden" name="roomid" value="<?php echo $record['treatmentroomid']; ?>">
                </td></tr>
                <tr><td colspan="2" align="right">
            ชื่อห้องตรวจ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="roomname" size='30' maxlength='50' value="<?php echo $record['name']; ?>">
                </td></tr>
                <tr><td colspan="4" align="center"><input type="submit" value="แก้ไข"></td></tr>
        </form>
    </table>
    </div>
    </center>
