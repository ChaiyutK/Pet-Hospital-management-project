...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1">เพิ่มข้อมูลยาและบริการ</div></center>
   <center>
   <form action="AdminManageDrugServiceInfoAddSave.php" method="post">
    <table width = '50%' border = "1"  bgcolor = "#FFFFFF">
            <tr><td colspan="4" align="center">
            รหัสยาและบริการ :&nbsp;
            <input type="text" size='30' name="drugid" maxlength='3' required>
                </td></tr>
            ...
            <select name="manufacturer" required>
               ...
               while($row=mysqli_fetch_array($result))
               {
               echo "<option value='$row[manufactid]'>$row[companyname]</option>";
                }
            require("../mysql/unconnect.php");
               ?>
               </select>
            ...
            สรรพคุณ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="properties" size='30' maxlength='30' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            วิธีใช้ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="instruction" size='30' maxlength='30' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            เพิ่มเติม :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="extra" size='30' maxlength='30'>
                </td></tr>
