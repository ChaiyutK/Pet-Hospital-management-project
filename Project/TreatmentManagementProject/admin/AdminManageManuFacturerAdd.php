...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1">เพิ่มข้อมูลผู้ผลิต</div></center>
   <center>
   <form action="AdminManageManuFacturerAddSave.php" method="post">
    <table width = '50%' border = "0"  bgcolor = "#FFFFFF">
            <tr><td colspan="4" align="center">
            รหัสผู้ผลิต :&nbsp;
            <input type="text" size='30' name="manufactid" maxlength='3' onkeypress="return isNumber(event)" required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ชื่อบริษัท :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="companyname" size='30' maxlength='30' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ชื่อติดต่อ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="contractname" size='30' maxlength='30' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ที่อยู่บริษัท :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="companyaddress" size='30' maxlength='30' required>
                </td></tr>
                <tr><td colspan="2" align="right">
            เบอร์ติดต่อ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="contractnumber" size='30' maxlength='10' onkeypress="return isNumber(event)" required>
                </td></tr>
