...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center>
   <form action="AdminManageDrugServiceHouseAddSave.php" method="post">
    <table width = '50%' border = "1"  bgcolor = "#FFFFFF">
            <tr><td colspan="4" align="center">
            รหัสคลังยาและบริการ :&nbsp;
            <input type="text" size='30' name="dshid" maxlength='1' onkeypress="return isNumber(event)" required>
                </td></tr>
            ...
            เบอร์ติดต่อ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="connumber" size='30' maxlength='10' onkeypress="return isNumber(event)">
                </td></tr>
