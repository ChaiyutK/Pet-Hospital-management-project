...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1">เพิ่มหมวดยาและบริการ</div></center>
   <center>
   <form action="AdminManageDrugServiceCatagoryAddSave.php" method="post">
    <table width = '50%' border = "0"  bgcolor = "#FFFFFF">
            <tr><td colspan="4" align="center">
            รหัสหมวดยาและบริการ :&nbsp;
            <input type="text" size='30' name="dcid" maxlength='3' onkeypress="return isNumber(event)">
                </td></tr>
            ...
            <?php   
                    ...
                    echo "<option value='1'>ยา</option>";
                    echo "<option value='2'>บริการ</option>";
                    echo "<option value='3'>วัคซีน</option>";
                    echo "</select>";
                ?>
                </td></tr>
