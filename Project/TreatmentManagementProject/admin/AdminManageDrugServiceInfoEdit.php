...
$sql2 ="select drugserviceinfo.DrugID AS drugid,drugserviceinfo.name AS name,drugservicecatagory.Name AS type,drugservicecatagory.dcid AS dcid,manufacturer.CompanyName AS companyname,manufacturer.manufactid AS manufactid,properties,instruction,extra from drugserviceinfo,drugservicecatagory,manufacturer where drugserviceinfo.DcID = drugservicecatagory.DcID and drugserviceinfo.manufactid = manufacturer.ManufactID and drugserviceinfo.drugid = '$drugid'";
...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1">แก้ไขข้อมูลยาและบริการ</div></center>
   <center>
   <form action="AdminManageDrugServiceInfoEditSave.php" method="post">
   <input type="hidden" name="drugid" value="<?php echo $drugid ?>">
    <table width = '50%' border = "1"  bgcolor = "#FFFFFF">
            ...
            ชื่อยาและบริการ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="name" size='30' maxlength='30' value="<?php echo $record2['name'] ?>" required>
                </td></tr>
                <tr><td colspan="2" align="right">
            บริษัทที่ผลิต :&nbsp;
            <td colspan="2" align="left">
            ...
            สรรพคุณ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="properties" size='30' maxlength='30' value="<?php echo $record2['properties'] ?>" required>
                </td></tr>
                <tr><td colspan="2" align="right">
            วิธีใช้ :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="instruction" size='30' maxlength='30' value="<?php echo $record2['instruction'] ?>" required>
                </td></tr>
                <tr><td colspan="2" align="right">
            เพิ่มเติม :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="extra" size='30' maxlength='30' value="<?php echo $record2['extra'] ?>">
                </td></tr>
