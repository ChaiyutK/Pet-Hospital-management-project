...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center>
   <form action="AdminEditUserSave.php" method="post">
    <table width = '50%' border = "0"  bgcolor = "#FFFFFF">
            ...
            <input type="hidden" name="userid" value="<?php echo $userid ?>">
               ...
               <td align = "left">รหัสไปรษณีย์ :</td><td><input type="text" name="Postnumber" size='30' onkeypress="return isNumber(event)" maxlength='5' value="<?php echo $record['postnumber']; ?>" required></td>
               </tr>
