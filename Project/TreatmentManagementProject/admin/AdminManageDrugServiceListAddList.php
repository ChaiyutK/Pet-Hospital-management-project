...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1">เพิ่มรายการยาและบริการ</div></center>
   <center>
   <form action="AdminManageDrugServiceListAddListSave.php" method="post">
   <input type="hidden" name="drugid" value="<?php echo $drugid ?>">
    <table width = '50%' border = "1"  bgcolor = "#FFFFFF">
            ...
            <td colspan="2" align="left" required>
            <input type="text" name="listid" size='30' maxlength='6'>
                </td></tr>
                <tr><td colspan="2" align="right">
            คลังที่เก็บ :&nbsp;
            <td colspan="2" align="left">
            <select name="dshid" required>
               ...
               while($row=mysqli_fetch_array($result))
               {
               echo "<option value='$row[dshid]'>$row[name]</option>";
                }
            require("../mysql/unconnect.php");
               ?>
               </select>
            ...
            จำนวน :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="balance" size='30' maxlength='30' onkeypress="return isNumber(event)" required>
                </td></tr>
                <tr><td colspan="2" align="right">
            ราคา :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="price" size='30' maxlength='30' onkeypress="return isNumber(event)" required>
                </td></tr>
                <tr><td colspan="2" align="right">
            หน่วย :&nbsp;
            <td colspan="2" align="left">
            <input type="text" name="unit" size='30' maxlength='30' required>
                </td></tr>
