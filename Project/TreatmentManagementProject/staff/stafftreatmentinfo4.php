...
<center><div class="head1">รายละเอียดการตรวจรักษา</div></center>
   ...
   <td align="center" width="20%">
   <a href="stafftreatmentinfo4.php?treatmentid=<?php echo $treatmentid; ?>&petid=<?php echo $petid; ?>" class="btn btn-info" role="button" style="height:100%;width:100%;">การวินิจฉัย</a>
   </td>
   <td align="center" width="20%">
