...
<center><div class="head1">ข้อมูลเจ้าของสัตว์เลี้ยง</div></center>
   <center>
   <form action="staffeditowner.php?userid='<?php echo $userid ?>'" method="post">
   <table width='50%' border="0" bgcolor="#FFFFFF">
   <tr>
   <td colspan="2" align="center" width="50%" bgcolor="#62FBF9">
   <a href="#" class="btn btn-info" role="button" style="height:100%;width:100%;">ข้อมูลเจ้าของสัตว์เลี้ยง</a>
   </td>
   <td colspan="2" align="center" width="50%" >
   <a href="staffownerpet.php?userid=<?php echo $userid; ?>" class="btn btn-default" role="button" style="height:100%;width:100%;">สัตว์เลี้ยงที่มี</a>
   </td>
   </tr>
   <tr><td colspan="4">
