...
<center><div class="head1">เพิ่มข้อมูลสัตว์เลี้ยง</div></center>
   <center>
   <form action="staffaddpetsave.php" method="post" onsubmit='Javascript:return chkdata()'>
    ...
    <table width = '40%' border = "1"  bgcolor = "#FFFFFF">
               <tr>
               <td align = "left" width="5%">ชื่อ : </td>
               <td width="25%"><input type="text" name="petname" size='30' maxlength='30' required></td>
               <td align = "right" width="16%">ประเภท : </td><td align="left">
               <select name="pettype" required>
               <option value="">กรุณาเลือกประเภทสัตว์เลี้ยง</option>
               <?php
               require("../mysql/unconnect.php");
               
               $sql="select pettypeid,name from pettype";
               require("../mysql/connect.php");
               while($row=mysqli_fetch_array($result)){
               echo "<option value='$row[pettypeid]'>$row[name]</option>";
            }
               ?>
               </select>
               </td>
               ...
               <tr>
               <td align = "left" width="6%">เพศ : </td>
               <td width="25%">
               <label>
                <input type="radio" name="gender" value="1" required>&nbsp;ผู้
                </label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label>
                  <input type="radio" name="gender" value="2" required>&nbsp;เมีย
                </label>
               </td>
               <td align = "right" width="16%">วันเกิด : </td><td align="left">
               <input name="birthday" class="form-control" type="date" id="example-date-input" required>
               </td>
               </tr>
               <tr>
               <td align = "left" width="10%">สายพันธุ์ : </td>
               <td width="25%"><input type="text" name="species" size='30' maxlength='30' required></td>
               <td align = "right" width="16%">ทำหมัน : </td>
               <td width="25%">
               <label>
                <input type="radio" name="sterilization" value="1" required>&nbsp;ทำแล้ว
                </label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label>
                  <input type="radio" name="sterilization" value="2" required>&nbsp;ยังไม่ทำ
                </label>
               </td>
               </tr>
