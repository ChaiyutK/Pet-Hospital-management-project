...
<form action="staffprintchoose.php" method="post">
   <center><div class="head1"><br>ออกรายงาน</div></center>
   <center>
   <table border="0">
   <tr>
    <td>รายงานที่ต้องการออก : <select name="selectreport">
    <option value="1">รายงานสถิติสัตว์ป่วยสสป.1</option>
    <option value="2">รายงานสถิติสัตว์ป่วยสสป.2</option>
    <option value="3">รายงานสถิติสัตว์ป่วยสสป.3</option>
    <option value="4">รายงานสถิติสัตว์ป่วยสสป.4</option>
    <option value="5">รายงานสถิติสัตว์ป่วยสสป.5</option>
    <option value="6">รายงานสถิติสัตว์ป่วยสสป.6</option>
    </select></td>
    <td>&nbsp;ปี ค.ศ.&nbsp; <input type='number' value="2020" name="year"></td>
    <td><input type="submit" value="เลือก"></td>
   </tr>
   </table>
   </center>
   </form>
