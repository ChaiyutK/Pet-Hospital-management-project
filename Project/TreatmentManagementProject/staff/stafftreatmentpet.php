  ...
  resize: none;
      ...
      <script>
        function TreatmentInfo(rec,rec2)
            {
                window.open("stafftreatmentinfo1.php?treatmentid=" + rec + "&petid=" + rec2,"_self");
            }
      </script>
  </head>
  <body>
...
<br><br>
<center><div class="head1">ประวัติการรักษา</div></center>
   <center>
   ...
   <td align="center" width="20%">
   <a href="#" class="btn btn-info" role="button" style="height:100%;width:100%;">ประวัติการรักษา</a>
   </td>
   <td align="center" width="20%">
...
<thead class="thead-dark">
    <tr align="center">
        ...
        $x=mysqli_num_rows($result);
         ...
         {
           ?>
          <a href='stafftreatmentpet.php?count=<?php echo $count ?>&page=<?php echo $i ?>&petid=<?php echo $petid ?>'><?php echo $i; ?>&nbsp;</a>
          <?php
            $count+=5;
         }
        ?></td></tr>
