...
$sql = "select userid,name,surname,status,name,surname,hnumber,village,alley,road,district,canton,province,postnumber,hpnumber,phonenumber,email from user where userid = $userid and level = 4";
...
<center><div class="head1">แก้ไขข้อมูลเจ้าของ</div></center>
<center>
   <form action="staffeditownersave.php" method="post">
   <input type="hidden" name="userid" value="<?php echo $userid ?>">
    <table width = '50%' border = "0"  bgcolor = "#FFFFFF">     
               ...
               <td align = "left">รหัสไปรษณีย์ :</td><td><input type="text" name="Postnumber" size='30' maxlength='30' value="<?php echo $record['postnumber']; ?>" maxlength='5' onkeypress="return isNumber(event)"></td>
               </tr>
                <tr><td colspan="2" align="right">เบอร์โทรศัพท์บ้าน :&nbsp;</td><td colspan="2" align="left"><input type="text" name="Hpnumber" value="<?php echo $record['hpnumber']; ?>" maxlength='9' onkeypress="return isNumber(event)"></td></tr>
                <tr><td colspan="2" align="right">เบอร์โทรศัพท์มือถือ :&nbsp;</td><td colspan="2" align="left"><input type="text" name="Phonenumber" value="<?php echo $record['phonenumber']; ?>" maxlength='10' onkeypress="return isNumber(event)"></td></tr>
                <tr><td colspan="2" align="right">อีเมล์ :&nbsp;</td><td colspan="2" align="left"><input type="text" name="Email" value="<?php echo $record['email']; ?>" ></td></tr>
