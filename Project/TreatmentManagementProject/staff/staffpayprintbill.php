...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center>
   <img src="../img/moneycartoon.png" width="200px" height="200px">
   <h1>เงินถอน : <?php echo $cashback; ?> บาท</h1>
   <table border="0">
   <tr>
   <td align="center" width="50%"><button type="button" class="btn btn-success" style="height:150px;width:150px;" onclick="window.open('staffprintbillpdf.php?treatmentid=' + <?php echo $treatmentid; ?> + '&cashget=' + <?php echo $cashget; ?> + '&cashback=' + <?php echo $cashback; ?>,'_self');">พิมพ์ใบเสร็จ</button></td>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $staffpaysystem; ?>','_self');">กลับไปหน้ารายการคิดเงิน</button></td>
   </tr>
   </table>
   </center>
