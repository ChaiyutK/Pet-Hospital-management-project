...
<center>
<h2>ระบบนัดหมาย</h2>
<form action="staffappointment.php" method="get">
<div style="width: 20%;">
    ...
    <tr align="center">
        ...
        $x=mysqli_num_rows($result);
         ...
         for($i=1;$i<=$count2;$i++)
         {
          ...
          {
           ?>
           <a href='staffappointment.php?count=<?php echo $count ?>&page=<?php echo $i ?>&wordsearch=<?php echo $_GET['wordsearch'] ?>'><?php echo $i; ?>&nbsp;</a>
