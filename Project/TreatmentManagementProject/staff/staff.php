...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <table border="0">
   <tr>
   <td align="center" width="25%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $staffregissystem; ?>','_self');">ระบบทะเบียน</button></td>
   <td align="center" width="25%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $staffpaysystem; ?>','_self');">ระบบคิดเงิน</button></td>
   <td align="center" width="25%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $staffappointment; ?>','_self');">ระบบนัดหมาย</button></td>
   <td align="center" width="25%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $staffeditself; ?>','_self');">แก้ไขโปรไฟล์ส่วนตัว</button></td>
   </tr>
   </table>
   </center>
