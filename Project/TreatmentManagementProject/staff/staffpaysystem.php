...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <center><div class="head1"><br>ระบบคิดเงิน</div></center>
   <center>
   <div style="width: 80%;">
...
<thead class="thead-dark">
   <tr bgcolor = "#d5f4e6" align="center">
    ...
    <tr align="center">
        ...
        ?>
        <td><button class="btn btn-info" onclick="petsendpaysystem('<?php echo $row['treatmentid']; ?>')">คิดเงิน</button>
        </td>
         <?php
          echo "</tr>";
        }
