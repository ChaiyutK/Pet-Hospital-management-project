...
if(empty($result))
{
    echo "<script>alert('เกิดข้อผิดพลาด');window.open('memberedithistory.php','_self')</script>";
}
$_SESSION['name'] = $Fname.' '.$Sname;
require("../mysql/unconnect.php");
echo "<script>alert('แก้ไขข้อมูลสำเร็จ');window.open('memberedithistory.php','_self')</script>";
