...
.btmenu {
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <table border="0">
   <tr>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $memberedithistory; ?>','_self');">แก้ไขประวัติ</button></td>
   <td align="center" width="50%"><button type="button" class="btn btn-primary" style="height:150px;width:150px;" onclick="window.open('<?php echo $membereditpassword; ?>','_self');">แก้ไขรหัสผ่าน</button></td>
   </tr>
   </table>
   </center>
